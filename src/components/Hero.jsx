      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-6">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white/[0.04] border border-cyan-500/30 backdrop-blur-xl shadow-inner text-xs font-semibold text-cyan-300">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.1]">
              RLabZ <span className="bg-gradient-to-r from-white via-slate-100 to-[#27a3ff] bg-clip-text text-transparent">Brand Identity Hub</span>
            </h1>
            ...
            <div className="pt-8 border-t border-white/10 w-full grid grid-cols-3 gap-4 text-left">
              <div className="bg-white/[0.04] backdrop-blur-2xl border border-white/15 rounded-3xl p-6 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] hover:border-cyan-400/30 transition-all duration-300">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-md bg-white/[0.04] backdrop-blur-2xl border border-white/15 rounded-3xl p-8 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] hover:border-cyan-400/30 transition-all duration-300 flex flex-col items-center justify-center text-center group">
              
              {/* Inner illuminated glass highlight ring */}
              <div className="absolute inset-4 rounded-2xl border border-dashed border-white/15 pointer-events-none group-hover:border-[#27a3ff]/40 transition-colors" />
              ...
              {/* Floating Glass Chips showing blade breakdown */}
