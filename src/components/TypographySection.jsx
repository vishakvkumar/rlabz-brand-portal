  ...
  return (
    <section id="typography" className="py-20 relative transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl p-8 border border-slate-800 bg-slate-900/60 backdrop-blur-xl mb-12">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-6 space-y-4">
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                <span className="px-3 py-1 rounded-lg bg-slate-800 text-slate-200 text-xs font-semibold border border-slate-700">
                  Regular 400
                </span>
                <span className="px-3 py-1 rounded-lg bg-slate-800 text-slate-200 text-xs font-semibold border border-slate-700">
                  Medium 500
        ...
        <div className="rounded-3xl p-8 border border-slate-800 bg-slate-900/40">
          ...
          <div className="space-y-6">
            {TYPOGRAPHY_SCALES.map((scale, idx) => (
              <div
                key={idx}
                className="p-6 rounded-2xl border bg-slate-900/80 border-slate-800 transition-all"
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800/40 pb-4 mb-4">
                ...
                {/* Rendered Sample */}
                <div
                  className="overflow-x-auto py-2 font-sans tracking-tight text-slate-100"
                  style={{
                ...
                <p className="text-xs mt-3 opacity-70 text-slate-400">
